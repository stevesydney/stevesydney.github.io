...
},serializeArray:function(){return this.map(function(){var elements=jQuery.prop(this,"elements");return elements?jQuery.makeArray(elements):this}).filter(function(){var type=this.type;return this.name&&!jQuery(this).is(":disabled")&&rsubmittable.test(this.nodeName)&&!rsubmitterTypes.test(type)&&(this.checked||!rcheckableType.test(type))}).map(function(i,elem){var val=jQuery(this).val();return null==val?null:jQuery.isArray(val)?jQuery.map(val,function(val){return{name:elem.name,value:val.replace(rCRLF,"\r\n")}}):{name:elem.name,value:val.replace(rCRLF,"\r\n")}}).get()}}),jQuery.ajaxSettings.xhr=function(){try{return new XMLHttpRequest}catch(e){}};var xhrId=0,xhrCallbacks={},xhrSuccessStatus={0:200,1223:204},xhrSupported=jQuery.ajaxSettings.xhr();window.ActiveXObject&&jQuery(window).on("unload",function(){for(var key in xhrCallbacks)xhrCallbacks[key]()}),support.cors=!!xhrSupported&&"withCredentials"in xhrSupported,support.ajax=xhrSupported=!!xhrSupported,jQuery.ajaxTransport(function(options){var callback;return support.cors||xhrSupported&&!options.crossDomain?{send:function(headers,complete){var i,xhr=options.xhr(),id=++xhrId;if(xhr.open(options.type,options.url,options.async,options.username,options.password),options.xhrFields)for(i in options.xhrFields)xhr[i]=options.xhrFields[i];options.mimeType&&xhr.overrideMimeType&&xhr.overrideMimeType(options.mimeType),options.crossDomain||headers["X-Requested-With"]||(headers["X-Requested-With"]="XMLHttpRequest");for(i in headers)xhr.setRequestHeader(i,headers[i]);callback=function(type){return function(){callback&&(delete xhrCallbacks[id],callback=xhr.onload=xhr.onerror=null,"abort"===type?xhr.abort():"error"===type?complete(xhr.status,xhr.statusText):complete(xhrSuccessStatus[xhr.status]||xhr.status,xhr.statusText,"string"==typeof xhr.responseText?{text:xhr.responseText}:void 0,xhr.getAllResponseHeaders()))}},xhr.onload=callback(),xhr.onerror=callback("error"),callback=xhrCallbacks[id]=callback("abort");try{xhr.send(options.hasContent&&options.data||null)}catch(e){if(callback)throw e}},abort:function(){callback&&callback()}}:void 0}),jQuery.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(text){return jQuery.globalEval(text),text}}}),jQuery.ajaxPrefilter("script",function(s){void 0===s.cache&&(s.cache=!1),s.crossDomain&&(s.type="GET")}),jQuery.ajaxTransport("script",function(s){if(s.crossDomain){var script,callback;return{send:function(_,complete){script=jQuery("<script>").prop({async:!0,charset:s.scriptCharset,src:s.url}).on("load error",callback=function(evt){script.remove(),callback=null,evt&&complete("error"===evt.type?404:200,evt.type)}),document.head.appendChild(script[0])},abort:function(){callback&&callback()}}}});var oldCallbacks=[],rjsonp=/(=)\?(?=&|$)|\?\?/;jQuery.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var callback=oldCallbacks.pop()||jQuery.expando+"_"+nonce++;return this[callback]=!0,callback}}),jQuery.ajaxPrefilter("json jsonp",function(s,originalSettings,jqXHR){var callbackName,overwritten,responseContainer,jsonProp=s.jsonp!==!1&&(rjsonp.test(s.url)?"url":"string"==typeof s.data&&!(s.contentType||"").indexOf("application/x-www-form-urlencoded")&&rjsonp.test(s.data)&&"data");return jsonProp||"jsonp"===s.dataTypes[0]?(callbackName=s.jsonpCallback=jQuery.isFunction(s.jsonpCallback)?s.jsonpCallback():s.jsonpCallback,jsonProp?s[jsonProp]=s[jsonProp].replace(rjsonp,"$1"+callbackName):s.jsonp!==!1&&(s.url+=(rquery.test(s.url)?"&":"?")+s.jsonp+"="+callbackName),s.converters["script json"]=function(){return responseContainer||jQuery.error(callbackName+" was not called"),responseContainer[0]},s.dataTypes[0]="json",overwritten=window[callbackName],window[callbackName]=function(){responseContainer=arguments},jqXHR.always(function(){window[callbackName]=overwritten,s[callbackName]&&(s.jsonpCallback=originalSettings.jsonpCallback,oldCallbacks.push(callbackName)),responseContainer&&jQuery.isFunction(overwritten)&&overwritten(responseContainer[0]),responseContainer=overwritten=void 0}),"script"):void 0}),jQuery.parseHTML=function(data,context,keepScripts){if(!data||"string"!=typeof data)return null;"boolean"==typeof context&&(keepScripts=context,context=!1),context=context||document;var parsed=rsingleTag.exec(data),scripts=!keepScripts&&[];return parsed?[context.createElement(parsed[1])]:(parsed=jQuery.buildFragment([data],context,scripts),scripts&&scripts.length&&jQuery(scripts).remove(),jQuery.merge([],parsed.childNodes))};var _load=jQuery.fn.load;jQuery.fn.load=function(url,params,callback){if("string"!=typeof url&&_load)return _load.apply(this,arguments);var selector,type,response,self=this,off=url.indexOf(" ");return off>=0&&(selector=jQuery.trim(url.slice(off)),url=url.slice(0,off)),jQuery.isFunction(params)?(callback=params,params=void 0):params&&"object"==typeof params&&(type="POST"),self.length>0&&jQuery.ajax({url:url,type:type,dataType:"html",data:params}).done(function(responseText){response=arguments,self.html(selector?jQuery("<div>").append(jQuery.parseHTML(responseText)).find(selector):responseText)}).complete(callback&&function(jqXHR,status){self.each(callback,response||[jqXHR.responseText,status,jqXHR])}),this},jQuery.expr.filters.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length};var docElem=window.document.documentElement;jQuery.offset={setOffset:function(elem,options,i){var curPosition,curLeft,curCSSTop,curTop,curOffset,curCSSLeft,calculatePosition,position=jQuery.css(elem,"position"),curElem=jQuery(elem),props={};"static"===position&&(elem.style.position="relative"),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&(curCSSTop+curCSSLeft).indexOf("auto")>-1,calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,curOffset)),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,elem=this[0],box={top:0,left:0},doc=elem&&elem.ownerDocument;if(doc)return docElem=doc.documentElement,jQuery.contains(docElem,elem)?(typeof elem.getBoundingClientRect!==strundefined&&(box=elem.getBoundingClientRect()),win=getWindow(doc),{top:box.top+win.pageYOffset-docElem.clientTop,left:box.left+win.pageXOffset-docElem.clientLeft}):box},position:function(){if(this[0]){var offsetParent,offset,elem=this[0],parentOffset={top:0,left:0};return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent||docElem;offsetParent&&!jQuery.nodeName(offsetParent,"html")&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||docElem})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?window.pageXOffset:val,top?val:window.pageYOffset):elem[method]=val)},method,val,arguments.length,null)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){return computed?(computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed):void 0})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery});var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},typeof noGlobal===strundefined&&(window.jQuery=window.$=jQuery),jQuery});var deviceIsAndroid=navigator.userAgent.indexOf("Android")>0,deviceIsIOS=/iP(ad|hone|od)/.test(navigator.userAgent),deviceIsIOS4=deviceIsIOS&&/OS 4_\d(_\d)?/.test(navigator.userAgent),deviceIsIOSWithBadTarget=deviceIsIOS&&/OS ([6-9]|\d{2})_\d/.test(navigator.userAgent),deviceIsBlackBerry10=navigator.userAgent.indexOf("BB10")>0;FastClick.prototype.needsClick=function(target){"use strict";switch(target.nodeName.toLowerCase()){case"button":case"select":case"textarea":if(target.disabled)return!0;break;case"input":if(deviceIsIOS&&"file"===target.type||target.disabled)return!0;break;case"label":case"video":return!0}return/\bneedsclick\b/.test(target.className)},FastClick.prototype.needsFocus=function(target){"use strict";switch(target.nodeName.toLowerCase()){case"textarea":return!0;case"select":return!deviceIsAndroid;case"input":switch(target.type){case"button":case"checkbox":case"file":case"image":case"radio":case"submit":return!1}return!target.disabled&&!target.readOnly;default:return/\bneedsfocus\b/.test(target.className)}},FastClick.prototype.sendClick=function(targetElement,event){"use strict";var clickEvent,touch;document.activeElement&&document.activeElement!==targetElement&&document.activeElement.blur(),touch=event.changedTouches[0],clickEvent=document.createEvent("MouseEvents"),clickEvent.initMouseEvent(this.determineEventType(targetElement),!0,!0,window,1,touch.screenX,touch.screenY,touch.clientX,touch.clientY,!1,!1,!1,!1,0,null),clickEvent.forwardedTouchEvent=!0,targetElement.dispatchEvent(clickEvent)},FastClick.prototype.determineEventType=function(targetElement){"use strict";return deviceIsAndroid&&"select"===targetElement.tagName.toLowerCase()?"mousedown":"click"},FastClick.prototype.focus=function(targetElement){"use strict";var length;deviceIsIOS&&targetElement.setSelectionRange&&0!==targetElement.type.indexOf("date")&&"time"!==targetElement.type?(length=targetElement.value.length,targetElement.setSelectionRange(length,length)):targetElement.focus()},FastClick.prototype.updateScrollParent=function(targetElement){"use strict";var scrollParent,parentElement;if(scrollParent=targetElement.fastClickScrollParent,!scrollParent||!scrollParent.contains(targetElement)){parentElement=targetElement;do{if(parentElement.scrollHeight>parentElement.offsetHeight){scrollParent=parentElement,targetElement.fastClickScrollParent=parentElement;break}parentElement=parentElement.parentElement}while(parentElement)}scrollParent&&(scrollParent.fastClickLastScrollTop=scrollParent.scrollTop)},FastClick.prototype.getTargetElementFromEventTarget=function(eventTarget){"use strict";return eventTarget.nodeType===Node.TEXT_NODE?eventTarget.parentNode:eventTarget},FastClick.prototype.onTouchStart=function(event){"use strict";var targetElement,touch,selection;if(event.targetTouches.length>1)return!0;if(targetElement=this.getTargetElementFromEventTarget(event.target),touch=event.targetTouches[0],deviceIsIOS){if(selection=window.getSelection(),selection.rangeCount&&!selection.isCollapsed)return!0;if(!deviceIsIOS4){if(touch.identifier&&touch.identifier===this.lastTouchIdentifier)return event.preventDefault(),!1;this.lastTouchIdentifier=touch.identifier,this.updateScrollParent(targetElement)}}return this.trackingClick=!0,this.trackingClickStart=event.timeStamp,this.targetElement=targetElement,this.touchStartX=touch.pageX,this.touchStartY=touch.pageY,event.timeStamp-this.lastClickTime<this.tapDelay&&event.preventDefault(),!0},FastClick.prototype.touchHasMoved=function(event){"use strict";var touch=event.changedTouches[0],boundary=this.touchBoundary;return Math.abs(touch.pageX-this.touchStartX)>boundary||Math.abs(touch.pageY-this.touchStartY)>boundary?!0:!1},FastClick.prototype.onTouchMove=function(event){"use strict";return this.trackingClick?((this.targetElement!==this.getTargetElementFromEventTarget(event.target)||this.touchHasMoved(event))&&(this.trackingClick=!1,this.targetElement=null),!0):!0},FastClick.prototype.findControl=function(labelElement){"use strict";return void 0!==labelElement.control?labelElement.control:labelElement.htmlFor?document.getElementById(labelElement.htmlFor):labelElement.querySelector("button, input:not([type=hidden]), keygen, meter, output, progress, select, textarea")},FastClick.prototype.onTouchEnd=function(event){"use strict";var forElement,trackingClickStart,targetTagName,scrollParent,touch,targetElement=this.targetElement;if(!this.trackingClick)return!0;if(event.timeStamp-this.lastClickTime<this.tapDelay)return this.cancelNextClick=!0,!0;if(this.cancelNextClick=!1,this.lastClickTime=event.timeStamp,trackingClickStart=this.trackingClickStart,this.trackingClick=!1,this.trackingClickStart=0,deviceIsIOSWithBadTarget&&(touch=event.changedTouches[0],targetElement=document.elementFromPoint(touch.pageX-window.pageXOffset,touch.pageY-window.pageYOffset)||targetElement,targetElement.fastClickScrollParent=this.targetElement.fastClickScrollParent),targetTagName=targetElement.tagName.toLowerCase(),"label"===targetTagName){if(forElement=this.findControl(targetElement)){if(this.focus(targetElement),deviceIsAndroid)return!1;targetElement=forElement}}else if(this.needsFocus(targetElement))return event.timeStamp-trackingClickStart>100||deviceIsIOS&&window.top!==window&&"input"===targetTagName?(this.targetElement=null,!1):(this.focus(targetElement),this.sendClick(targetElement,event),deviceIsIOS&&"select"===targetTagName||(this.targetElement=null,event.preventDefault()),!1);return deviceIsIOS&&!deviceIsIOS4&&(scrollParent=targetElement.fastClickScrollParent,scrollParent&&scrollParent.fastClickLastScrollTop!==scrollParent.scrollTop)?!0:(this.needsClick(targetElement)||(event.preventDefault(),this.sendClick(targetElement,event)),!1)},FastClick.prototype.onTouchCancel=function(){"use strict";this.trackingClick=!1,this.targetElement=null},FastClick.prototype.onMouse=function(event){"use strict";return this.targetElement?event.forwardedTouchEvent?!0:event.cancelable&&(!this.needsClick(this.targetElement)||this.cancelNextClick)?(event.stopImmediatePropagation?event.stopImmediatePropagation():event.propagationStopped=!0,event.stopPropagation(),event.preventDefault(),!1):!0:!0},FastClick.prototype.onClick=function(event){"use strict";var permitted;return this.trackingClick?(this.targetElement=null,this.trackingClick=!1,!0):"submit"===event.target.type&&0===event.detail?!0:(permitted=this.onMouse(event),permitted||(this.targetElement=null),permitted)},FastClick.prototype.destroy=function(){"use strict";var layer=this.layer;deviceIsAndroid&&(layer.removeEventListener("mouseover",this.onMouse,!0),layer.removeEventListener("mousedown",this.onMouse,!0),layer.removeEventListener("mouseup",this.onMouse,!0)),layer.removeEventListener("click",this.onClick,!0),layer.removeEventListener("touchstart",this.onTouchStart,!1),layer.removeEventListener("touchmove",this.onTouchMove,!1),layer.removeEventListener("touchend",this.onTouchEnd,!1),layer.removeEventListener("touchcancel",this.onTouchCancel,!1)},FastClick.notNeeded=function(layer){"use strict";var metaViewport,chromeVersion,blackberryVersion;if("undefined"==typeof window.ontouchstart)return!0;if(chromeVersion=+(/Chrome\/([0-9]+)/.exec(navigator.userAgent)||[,0])[1]){if(!deviceIsAndroid)return!0;if(metaViewport=document.querySelector("meta[name=viewport]")){if(-1!==metaViewport.content.indexOf("user-scalable=no"))return!0;if(chromeVersion>31&&document.documentElement.scrollWidth<=window.outerWidth)return!0}}if(deviceIsBlackBerry10&&(blackberryVersion=navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),blackberryVersion[1]>=10&&blackberryVersion[2]>=3&&(metaViewport=document.querySelector("meta[name=viewport]")))){if(-1!==metaViewport.content.indexOf("user-scalable=no"))return!0;if(document.documentElement.scrollWidth<=window.outerWidth)return!0}return"none"===layer.style.msTouchAction?!0:!1},FastClick.attach=function(layer,options){"use strict";return new FastClick(layer,options)},"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){"use strict";return FastClick}):"undefined"!=typeof module&&module.exports?(module.exports=FastClick.attach,module.exports.FastClick=FastClick):window.FastClick=FastClick,function(){var $,OriDomi,addStyle,anchorList,anchorListH,anchorListV,baseName,capitalize,cloneEl,createEl,css,defaults,defer,elClasses,getGradient,hideEl,isSupported,k,libName,noOp,prefixList,prep,showEl,styleBuffer,supportWarning,testEl,testProp,v,_ref,__bind=function(fn,me){return function(){return fn.apply(me,arguments)}},__indexOf=[].indexOf||function(item){for(var i=0,l=this.length;l>i;i++)if(i in this&&this[i]===item)return i;return-1},__slice=[].slice;libName="OriDomi",isSupported=!0,supportWarning=function(prop){return"undefined"!=typeof console&&null!==console&&console.warn(""+libName+": Missing support for `"+prop+"`."),isSupported=!1},testProp=function(prop){var full,prefix,_i,_len;for(_i=0,_len=prefixList.length;_len>_i;_i++)if(prefix=prefixList[_i],(full=prefix+capitalize(prop))in testEl.style)return full;return prop in testEl.style?prop:!1},addStyle=function(selector,rules){var prop,style,val;style="."+selector+"{";for(prop in rules)val=rules[prop],prop in css&&(prop=css[prop],prop.match(/^(webkit|moz|ms)/i)&&(prop="-"+prop)),style+=""+prop.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()+":"+val+";";return styleBuffer+=style+"}"},getGradient=function(anchor){return""+css.gradientProp+"("+anchor+", rgba(0, 0, 0, .5) 0%, rgba(255, 255, 255, .35) 100%)"},capitalize=function(s){return s[0].toUpperCase()+s.slice(1)},createEl=function(className){var el;return el=document.createElement("div"),el.className=elClasses[className],el},cloneEl=function(parent,deep,className){var el;return el=parent.cloneNode(deep),el.classList.add(elClasses[className]),el},hideEl=function(el){return el.style[css.transform]="translate3d(-99999px, 0, 0)"},showEl=function(el){return el.style[css.transform]="translate3d(0, 0, 0)"},prep=function(fn){return function(){var a0,a1,a2,anchor,angle,opt;if(this._touchStarted)return fn.apply(this,arguments);switch(a0=arguments[0],a1=arguments[1],a2=arguments[2],opt={},angle=anchor=null,fn.length){case 1:opt.callback=a0;break;case 2:"function"==typeof a0?opt.callback=a0:(anchor=a0,opt.callback=a1);break;case 3:angle=a0,2===arguments.length?"object"==typeof a1?opt=a1:"function"==typeof a1?opt.callback=a1:anchor=a1:3===arguments.length&&(anchor=a1,"object"==typeof a2?opt=a2:"function"==typeof a2&&(opt.callback=a2))}return null==angle&&(angle=this._lastOp.angle||0),anchor||(anchor=this._lastOp.anchor),this._queue.push([fn,this._normalizeAngle(angle),this._getLonghandAnchor(anchor),opt]),this._step(),this}},defer=function(fn){return setTimeout(fn,0)},noOp=function(){},$=("undefined"!=typeof window&&null!==window&&null!=(_ref=window.$)?_ref.data:void 0)?window.$:null,anchorList=["left","right","top","bottom"],anchorListV=anchorList.slice(0,2),anchorListH=anchorList.slice(2),testEl=document.createElement("div"),styleBuffer="",prefixList=["Webkit","Moz","ms"],baseName=libName.toLowerCase(),elClasses={active:"active",clone:"clone",holder:"holder",stage:"stage",stageLeft:"stage-left",stageRight:"stage-right",stageTop:"stage-top",stageBottom:"stage-bottom",content:"content",mask:"mask",maskH:"mask-h",maskV:"mask-v",panel:"panel",panelH:"panel-h",panelV:"panel-v",shader:"shader",shaderLeft:"shader-left",shaderRight:"shader-right",shaderTop:"shader-top",shaderBottom:"shader-bottom"};for(k in elClasses)v=elClasses[k],elClasses[k]=""+baseName+"-"+v;css=new function(){var key,_i,_len,_ref1;for(_ref1=["transform","transformOrigin","transformStyle","transitionProperty","transitionDuration","transitionDelay","transitionTimingFunction","perspective","perspectiveOrigin","backfaceVisibility","boxSizing","mask"],_i=0,_len=_ref1.length;_len>_i;_i++)key=_ref1[_i],this[key]=key;return this},function(){var key,p3d,prefix,styleEl,value,_ref1;for(key in css)if(value=css[key],css[key]=testProp(value),!css[key])return supportWarning(value);return p3d="preserve-3d",testEl.style[css.transformStyle]=p3d,testEl.style[css.transformStyle]!==p3d?supportWarning(p3d):(css.gradientProp=function(){var hyphenated,prefix,_i,_len;for(_i=0,_len=prefixList.length;_len>_i;_i++)if(prefix=prefixList[_i],hyphenated="-"+prefix.toLowerCase()+"-linear-gradient",testEl.style.backgroundImage=""+hyphenated+"(left, #000, #fff)",-1!==testEl.style.backgroundImage.indexOf("gradient"))return hyphenated;return"linear-gradient"}(),_ref1=function(){var grabValue,plainGrab,prefix,_i,_len;for(_i=0,_len=prefixList.length;_len>_i;_i++)if(prefix=prefixList[_i],plainGrab="grab",testEl.style.cursor=grabValue="-"+prefix.toLowerCase()+"-"+plainGrab,testEl.style.cursor===grabValue)return[grabValue,"-"+prefix.toLowerCase()+"-grabbing"];return testEl.style.cursor=plainGrab,testEl.style.cursor===plainGrab?[plainGrab,"grabbing"]:["move","move"]}(),css.grab=_ref1[0],css.grabbing=_ref1[1],css.transformProp=(prefix=css.transform.match(/(\w+)Transform/i))?"-"+prefix[1].toLowerCase()+"-transform":"transform",css.transitionEnd=function(){switch(css.transitionProperty.toLowerCase()){case"transitionproperty":return"transitionEnd";case"webkittransitionproperty":return"webkitTransitionEnd";case"moztransitionproperty":return"transitionend";case"mstransitionproperty":return"msTransitionEnd"}}(),function(i){var anchor,_i,_len,_ref2;addStyle(elClasses.active,{backgroundColor:i("transparent"),backgroundImage:i("none"),boxSizing:i("border-box"),border:i("none"),outline:i("none"),padding:i("0"),transformStyle:i(p3d),mask:i("none"),position:"relative"}),addStyle(elClasses.clone,{margin:i("0"),boxSizing:i("border-box"),overflow:i("hidden"),display:i("block")}),addStyle(elClasses.holder,{width:"100%",position:"absolute",top:"0",bottom:"0",transformStyle:p3d}),addStyle(elClasses.stage,{width:"100%",height:"100%",position:"absolute",transform:"translate3d(-9999px, 0, 0)",margin:"0",padding:"0",transformStyle:p3d}),_ref2={Left:"0% 50%",Right:"100% 50%",Top:"50% 0%",Bottom:"50% 100%"};for(k in _ref2)v=_ref2[k],addStyle(elClasses["stage"+k],{perspectiveOrigin:v});for(addStyle(elClasses.shader,{width:"100%",height:"100%",position:"absolute",opacity:"0",top:"0",left:"0",pointerEvents:"none",transitionProperty:"opacity"}),_i=0,_len=anchorList.length;_len>_i;_i++)anchor=anchorList[_i],addStyle(elClasses["shader"+capitalize(anchor)],{background:getGradient(anchor)});return addStyle(elClasses.content,{margin:i("0"),position:i("relative"),"float":i("none"),boxSizing:i("border-box"),overflow:i("hidden")}),addStyle(elClasses.mask,{width:"100%",height:"100%",position:"absolute",overflow:"hidden",transform:"translate3d(0, 0, 0)",outline:"1px solid transparent"}),addStyle(elClasses.panel,{width:"100%",height:"100%",padding:"0",position:"absolute",transitionProperty:css.transformProp,transformOrigin:"left",transformStyle:p3d}),addStyle(elClasses.panelH,{transformOrigin:"top"}),addStyle(""+elClasses.stageRight+" ."+elClasses.panel,{transformOrigin:"right"}),addStyle(""+elClasses.stageBottom+" ."+elClasses.panel,{transformOrigin:"bottom"})}(function(s){return s+" !important"}),styleEl=document.createElement("style"),styleEl.type="text/css",styleEl.styleSheet?styleEl.styleSheet.cssText=styleBuffer:styleEl.appendChild(document.createTextNode(styleBuffer)),document.head.appendChild(styleEl))}(),defaults={vPanels:3,hPanels:3,perspective:1e3,shading:"hard",speed:700,maxAngle:90,ripple:0,oriDomiClass:libName.toLowerCase(),shadingIntensity:1,easingMethod:"",gapNudge:1.5,touchEnabled:!0,touchSensitivity:.25,touchStartCallback:noOp,touchMoveCallback:noOp,touchEndCallback:noOp},OriDomi=function(){function OriDomi(el,options){var a,anchor,anchorSet,axis,classSuffix,content,contentHolder,count,i,index,mask,maskProto,metric,offsets,panel,panelConfig,panelKey,panelN,panelProto,percent,prev,proto,rightOrBottom,shaderProto,shaderProtos,side,stageProto,_i,_j,_k,_l,_len,_len1,_len2,_len3,_len4,_len5,_len6,_len7,_m,_n,_o,_p,_q,_ref1,_ref2;if(this.el=el,null==options&&(options={}),this._onMouseOut=__bind(this._onMouseOut,this),this._onTouchLeave=__bind(this._onTouchLeave,this),this._onTouchEnd=__bind(this._onTouchEnd,this),this._onTouchMove=__bind(this._onTouchMove,this),this._onTouchStart=__bind(this._onTouchStart,this),this._stageReset=__bind(this._stageReset,this),this._conclude=__bind(this._conclude,this),this._onTransitionEnd=__bind(this._onTransitionEnd,this),this._step=__bind(this._step,this),isSupported){if(!(this instanceof OriDomi))return new OriDomi(this.el,options);if("string"==typeof this.el&&(this.el=document.querySelector(this.el)),!this.el||1!==this.el.nodeType)return void("undefined"!=typeof console&&null!==console&&console.warn(""+libName+": First argument must be a DOM element"));this._config=new function(){for(k in defaults)v=defaults[k],this[k]=k in options?options[k]:v;return this},this._config.ripple=Number(this._config.ripple),this._queue=[],this._panels={},this._stages={},this._lastOp={anchor:anchorList[0]},this._shading=this._config.shading,this._shading===!0&&(this._shading="hard"),this._shading&&(this._shaders={},shaderProtos={},shaderProto=createEl("shader"),shaderProto.style[css.transitionDuration]=this._config.speed+"ms",shaderProto.style[css.transitionTimingFunction]=this._config.easingMethod),stageProto=createEl("stage"),stageProto.style[css.perspective]=this._config.perspective+"px";for(_i=0,_len=anchorList.length;_len>_i;_i++)if(anchor=anchorList[_i],this._panels[anchor]=[],this._stages[anchor]=cloneEl(stageProto,!1,"stage"+capitalize(anchor)),this._shading){if(this._shaders[anchor]={},__indexOf.call(anchorListV,anchor)>=0)for(_j=0,_len1=anchorListV.length;_len1>_j;_j++)side=anchorListV[_j],this._shaders[anchor][side]=[];else for(_k=0,_len2=anchorListH.length;_len2>_k;_k++)side=anchorListH[_k],this._shaders[anchor][side]=[];shaderProtos[anchor]=cloneEl(shaderProto,!1,"shader"+capitalize(anchor))}for(contentHolder=cloneEl(this.el,!0,"content"),maskProto=createEl("mask"),maskProto.appendChild(contentHolder),panelProto=createEl("panel"),panelProto.style[css.transitionDuration]=this._config.speed+"ms",panelProto.style[css.transitionTimingFunction]=this._config.easingMethod,offsets={left:[],top:[]},_ref1=["x","y"],_l=0,_len3=_ref1.length;_len3>_l;_l++){if(axis=_ref1[_l],"x"===axis?(anchorSet=anchorListV,metric="width",classSuffix="V"):(anchorSet=anchorListH,metric="height",classSuffix="H"),panelConfig=this._config[panelKey=classSuffix.toLowerCase()+"Panels"],"number"==typeof panelConfig)count=Math.abs(parseInt(panelConfig,10)),percent=100/count,panelConfig=this._config[panelKey]=function(){var _m,_results;for(_results=[],_m=0;count>=0?count>_m:_m>count;count>=0?_m++:_m--)_results.push(percent);return _results}();else if(count=panelConfig.length,!(99<=(_ref2=panelConfig.reduce(function(p,c){return p+c}))&&100.1>=_ref2))throw new Error(""+libName+": Panel percentages do not sum to 100");if(mask=cloneEl(maskProto,!0,"mask"+classSuffix),this._shading)for(_m=0,_len4=anchorSet.length;_len4>_m;_m++)anchor=anchorSet[_m],mask.appendChild(shaderProtos[anchor]);for(proto=cloneEl(panelProto,!1,"panel"+classSuffix),proto.appendChild(mask),rightOrBottom=_n=0,_len5=anchorSet.length;_len5>_n;rightOrBottom=++_n){for(anchor=anchorSet[rightOrBottom],panelN=_o=0;count>=0?count>_o:_o>count;panelN=count>=0?++_o:--_o){if(panel=proto.cloneNode(!0),content=panel.children[0].children[0],content.style.width=content.style.height="100%",rightOrBottom?(panel.style[css.origin]=anchor,index=panelConfig.length-panelN-1,prev=index+1):(index=panelN,prev=index-1,offsets[anchor].push(0===panelN?0:(offsets[anchor][prev]-100)*(panelConfig[prev]/panelConfig[index]))),0===panelN?(panel.style[anchor]="0",panel.style[metric]=panelConfig[index]+"%"):(panel.style[anchor]="100%",panel.style[metric]=panelConfig[index]/panelConfig[prev]*100+"%"),this._shading)for(i=_p=0,_len6=anchorSet.length;_len6>_p;i=++_p)a=anchorSet[i],this._shaders[anchor][a][panelN]=panel.children[0].children[i+1];content.style[metric]=content.style["max"+capitalize(metric)]=count/panelConfig[index]*1e4/count+"%",content.style[anchorSet[0]]=offsets[anchorSet[0]][index]+"%",this._transformPanel(panel,0,anchor),this._panels[anchor][panelN]=panel,0!==panelN&&this._panels[anchor][panelN-1].appendChild(panel)}this._stages[anchor].appendChild(this._panels[anchor][0])}}for(this._stageHolder=createEl("holder"),this._stageHolder.setAttribute("aria-hidden","true"),_q=0,_len7=anchorList.length;_len7>_q;_q++)anchor=anchorList[_q],this._stageHolder.appendChild(this._stages[anchor]);"absolute"===window.getComputedStyle(this.el).position&&(this.el.style.position="absolute"),this.el.classList.add(elClasses.active),showEl(this._stages.left),this._cloneEl=cloneEl(this.el,!0,"clone"),this._cloneEl.classList.remove(elClasses.active),hideEl(this._cloneEl),this.el.innerHTML="",this.el.appendChild(this._cloneEl),this.el.appendChild(this._stageHolder),this.el.parentNode.style[css.transformStyle]="preserve-3d",this.accordion(0),this._config.ripple&&this.setRipple(this._config.ripple),this._config.touchEnabled&&this.enableTouch()}}return OriDomi.prototype._step=function(){var anchor,angle,fn,next,options,_ref1;if(!this._inTrans&&this._queue.length)return this._inTrans=!0,_ref1=this._queue.shift(),fn=_ref1[0],angle=_ref1[1],anchor=_ref1[2],options=_ref1[3],this.isFrozen&&this.unfreeze(),next=function(_this){return function(){var args;return _this._setCallback({angle:angle,anchor:anchor,options:options,fn:fn}),args=[angle,anchor,options],fn.length<3&&args.shift(),fn.apply(_this,args)}}(this),this.isFoldedUp?2===fn.length?next():this._unfold(next):anchor!==this._lastOp.anchor?this._stageReset(anchor,next):next()},OriDomi.prototype._isIdenticalOperation=function(op){var key,_i,_len,_ref1,_ref2;if(!this._lastOp.fn)return!0;if(this._lastOp.reset)return!1;for(_ref1=["angle","anchor","fn"],_i=0,_len=_ref1.length;_len>_i;_i++)if(key=_ref1[_i],this._lastOp[key]!==op[key])return!1;_ref2=op.options;for(k in _ref2)if(v=_ref2[k],v!==this._lastOp.options[k]&&"callback"!==k)return!1;return!0},OriDomi.prototype._setCallback=function(operation){return!this._config.speed||this._isIdenticalOperation(operation)?this._conclude(operation.options.callback):this._panels[this._lastOp.anchor][0].addEventListener(css.transitionEnd,this._onTransitionEnd,!1),(this._lastOp=operation).reset=!1},OriDomi.prototype._onTransitionEnd=function(e){return e.currentTarget.removeEventListener(css.transitionEnd,this._onTransitionEnd,!1),this._conclude(this._lastOp.options.callback,e)
},OriDomi.prototype._conclude=function(cb,event){return defer(function(_this){return function(){return _this._inTrans=!1,_this._step(),"function"==typeof cb?cb(event,_this):void 0}}(this))},OriDomi.prototype._transformPanel=function(el,angle,anchor,fracture){var transPrefix,x,y,z;switch(x=y=z=0,anchor){case"left":y=angle,transPrefix="X(-";break;case"right":y=-angle,transPrefix="X(";break;case"top":x=-angle,transPrefix="Y(-";break;case"bottom":x=angle,transPrefix="Y("}return fracture&&(x=y=z=angle),el.style[css.transform]="rotateX("+x+"deg) rotateY("+y+"deg) rotateZ("+z+"deg) translate"+transPrefix+this._config.gapNudge+"px)"},OriDomi.prototype._normalizeAngle=function(angle){var max;return angle=parseFloat(angle,10),max=this._config.maxAngle,isNaN(angle)?0:angle>max?max:-max>angle?-max:angle},OriDomi.prototype._setTrans=function(duration,delay,anchor){return null==anchor&&(anchor=this._lastOp.anchor),this._iterate(anchor,function(_this){return function(){return _this._setPanelTrans.apply(_this,[anchor].concat(__slice.call(arguments),[duration],[delay]))}}(this))},OriDomi.prototype._setPanelTrans=function(anchor,panel,i,len,duration,delay){var delayMs,shader,side,_i,_len,_ref1;if(delayMs=function(){switch(delay){case 0:return 0;case 1:return this._config.speed/len*i;case 2:return this._config.speed/len*(len-i-1)}}.call(this),panel.style[css.transitionDuration]=duration+"ms",panel.style[css.transitionDelay]=delayMs+"ms",this._shading)for(_ref1=__indexOf.call(anchorListV,anchor)>=0?anchorListV:anchorListH,_i=0,_len=_ref1.length;_len>_i;_i++)side=_ref1[_i],shader=this._shaders[anchor][side][i],shader.style[css.transitionDuration]=duration+"ms",shader.style[css.transitionDelay]=delayMs+"ms";return delayMs},OriDomi.prototype._setShader=function(n,anchor,angle){var a,abs,b,opacity;return abs=Math.abs(angle),opacity=abs/90*this._config.shadingIntensity,"hard"===this._shading?(opacity*=.15,angle=this._lastOp.angle<0?abs:-abs):opacity*=.4,__indexOf.call(anchorListV,anchor)>=0?(0>angle?(a=opacity,b=0):(a=0,b=opacity),this._shaders[anchor].left[n].style.opacity=a,this._shaders[anchor].right[n].style.opacity=b):(0>angle?(a=0,b=opacity):(a=opacity,b=0),this._shaders[anchor].top[n].style.opacity=a,this._shaders[anchor].bottom[n].style.opacity=b)},OriDomi.prototype._showStage=function(anchor){return anchor!==this._lastOp.anchor?(hideEl(this._stages[this._lastOp.anchor]),this._lastOp.anchor=anchor,this._lastOp.reset=!0,this._stages[anchor].style[css.transform]="translate3d("+function(){switch(anchor){case"left":return"0, 0, 0)";case"right":return"-"+this._config.vPanels.length+"px, 0, 0)";case"top":return"0, 0, 0)";case"bottom":return"0, -"+this._config.hPanels.length+"px, 0)"}}.call(this)):void 0},OriDomi.prototype._stageReset=function(anchor,cb){var fn;return fn=function(_this){return function(e){return e&&e.currentTarget.removeEventListener(css.transitionEnd,fn,!1),_this._showStage(anchor),defer(cb)}}(this),0===this._lastOp.angle?fn():(this._panels[this._lastOp.anchor][0].addEventListener(css.transitionEnd,fn,!1),this._iterate(this._lastOp.anchor,function(_this){return function(panel,i){return _this._transformPanel(panel,0,_this._lastOp.anchor),_this._shading?_this._setShader(i,_this._lastOp.anchor,0):void 0}}(this)))},OriDomi.prototype._getLonghandAnchor=function(shorthand){switch(shorthand.toString()){case"left":case"l":case"4":return"left";case"right":case"r":case"2":return"right";case"top":case"t":case"1":return"top";case"bottom":case"b":case"3":return"bottom";default:return"left"}},OriDomi.prototype._setCursor=function(bool){return null==bool&&(bool=this._touchEnabled),this.el.style.cursor=bool?css.grab:"default"},OriDomi.prototype._setTouch=function(toggle){var eString,eventPair,eventPairs,listenFn,mouseLeaveSupport,_i,_j,_len,_len1;if(toggle){if(this._touchEnabled)return this;listenFn="addEventListener"}else{if(!this._touchEnabled)return this;listenFn="removeEventListener"}this._touchEnabled=toggle,this._setCursor(),eventPairs=[["TouchStart","MouseDown"],["TouchEnd","MouseUp"],["TouchMove","MouseMove"],["TouchLeave","MouseLeave"]],mouseLeaveSupport="onmouseleave"in window;for(_i=0,_len=eventPairs.length;_len>_i;_i++)for(eventPair=eventPairs[_i],_j=0,_len1=eventPair.length;_len1>_j;_j++){if(eString=eventPair[_j],"TouchLeave"===eString&&!mouseLeaveSupport){this.el[listenFn]("mouseout",this._onMouseOut,!1);break}this.el[listenFn](eString.toLowerCase(),this["_on"+eventPair[0]],!1)}return this},OriDomi.prototype._onTouchStart=function(e){var axis1,_ref1;if(this._touchEnabled&&!this.isFoldedUp)return e.preventDefault(),this.emptyQueue(),this._touchStarted=!0,this.el.style.cursor=css.grabbing,this._setTrans(0,0),this._touchAxis=(_ref1=this._lastOp.anchor,__indexOf.call(anchorListV,_ref1)>=0?"x":"y"),this["_"+this._touchAxis+"Last"]=this._lastOp.angle,axis1="_"+this._touchAxis+"1",this[axis1]="mousedown"===e.type?e["page"+this._touchAxis.toUpperCase()]:e.targetTouches[0]["page"+this._touchAxis.toUpperCase()],this._config.touchStartCallback(this[axis1],e)},OriDomi.prototype._onTouchMove=function(e){var current,delta,distance;if(this._touchEnabled&&this._touchStarted)return e.preventDefault(),current="mousemove"===e.type?e["page"+this._touchAxis.toUpperCase()]:e.targetTouches[0]["page"+this._touchAxis.toUpperCase()],distance=(current-this["_"+this._touchAxis+"1"])*this._config.touchSensitivity,this._lastOp.angle<0?(delta="right"===this._lastOp.anchor||"bottom"===this._lastOp.anchor?this["_"+this._touchAxis+"Last"]-distance:this["_"+this._touchAxis+"Last"]+distance,delta>0&&(delta=0)):(delta="right"===this._lastOp.anchor||"bottom"===this._lastOp.anchor?this["_"+this._touchAxis+"Last"]+distance:this["_"+this._touchAxis+"Last"]-distance,0>delta&&(delta=0)),this._lastOp.angle=delta=this._normalizeAngle(delta),this._lastOp.fn.call(this,delta,this._lastOp.anchor,this._lastOp.options),this._config.touchMoveCallback(delta,e)},OriDomi.prototype._onTouchEnd=function(e){return this._touchEnabled?(this._touchStarted=this._inTrans=!1,this.el.style.cursor=css.grab,this._setTrans(this._config.speed,this._config.ripple),this._config.touchEndCallback(this["_"+this._touchAxis+"Last"],e)):void 0},OriDomi.prototype._onTouchLeave=function(e){return this._touchEnabled&&this._touchStarted?this._onTouchEnd(e):void 0},OriDomi.prototype._onMouseOut=function(e){return this._touchEnabled&&this._touchStarted&&e.toElement&&!this.el.contains(e.toElement)?this._onTouchEnd(e):void 0},OriDomi.prototype._unfold=function(callback){var anchor;return this._inTrans=!0,anchor=this._lastOp.anchor,this._iterate(anchor,function(_this){return function(panel,i,len){var delay;return delay=_this._setPanelTrans.apply(_this,[anchor].concat(__slice.call(arguments),[_this._config.speed],[1])),function(panel,i,delay){return defer(function(){return _this._transformPanel(panel,0,anchor),_this._shading&&_this._setShader(i,anchor,0),setTimeout(function(){return showEl(panel.children[0]),i===len-1&&(_this._inTrans=_this.isFoldedUp=!1,"function"==typeof callback&&callback(),_this._lastOp.fn=_this.accordion,_this._lastOp.angle=0),defer(function(){return panel.style[css.transitionDuration]=_this._config.speed})},delay+.25*_this._config.speed)})}(panel,i,delay)}}(this))},OriDomi.prototype._iterate=function(anchor,fn){var i,panel,panels,_i,_len,_ref1,_results;for(_ref1=panels=this._panels[anchor],_results=[],i=_i=0,_len=_ref1.length;_len>_i;i=++_i)panel=_ref1[i],_results.push(fn.call(this,panel,i,panels.length));return _results},OriDomi.prototype.enableTouch=function(){return this._setTouch(!0)},OriDomi.prototype.disableTouch=function(){return this._setTouch(!1)},OriDomi.prototype.setSpeed=function(speed){var anchor,_i,_len;for(_i=0,_len=anchorList.length;_len>_i;_i++)anchor=anchorList[_i],this._setTrans(this._config.speed=speed,this._config.ripple,anchor);return this},OriDomi.prototype.freeze=function(callback){return this.isFrozen?"function"==typeof callback&&callback():this._stageReset(this._lastOp.anchor,function(_this){return function(){return _this.isFrozen=!0,hideEl(_this._stageHolder),showEl(_this._cloneEl),_this._setCursor(!1),"function"==typeof callback?callback():void 0}}(this)),this},OriDomi.prototype.unfreeze=function(){return this.isFrozen&&(this.isFrozen=!1,hideEl(this._cloneEl),showEl(this._stageHolder),this._setCursor(),this._lastOp.angle=0),this},OriDomi.prototype.destroy=function(callback){return this.freeze(function(_this){return function(){return _this._setTouch(!1),$&&$.data(_this.el,baseName,null),_this.el.innerHTML=_this._cloneEl.innerHTML,_this.el.classList.remove(elClasses.active),"function"==typeof callback?callback():void 0}}(this)),null},OriDomi.prototype.emptyQueue=function(){return this._queue=[],defer(function(_this){return function(){return _this._inTrans=!1}}(this)),this},OriDomi.prototype.setRipple=function(dir){return null==dir&&(dir=1),this._config.ripple=Number(dir),this.setSpeed(this._config.speed),this},OriDomi.prototype.constrainAngle=function(angle){return this._config.maxAngle=parseFloat(angle,10)||defaults.maxAngle,this},OriDomi.prototype.wait=function(ms){var fn;return fn=function(_this){return function(){return setTimeout(_this._conclude,ms)}}(this),this._inTrans?this._queue.push([fn,this._lastOp.angle,this._lastOp.anchor,this._lastOp.options]):fn(),this},OriDomi.prototype.modifyContent=function(fn){var anchor,i,panel,selectors,set,_i,_j,_len,_len1,_ref1;for("function"!=typeof fn&&(selectors=fn,set=function(el,content,style){var key,value;if(content&&(el.innerHTML=content),style){for(key in style)value=style[key],el.style[key]=value;return null}},fn=function(el){var content,match,selector,style,value,_i,_len,_ref1;for(selector in selectors)if(value=selectors[selector],content=style=null,"string"==typeof value?content=value:(content=value.content,style=value.style),""!==selector)for(_ref1=el.querySelectorAll(selector),_i=0,_len=_ref1.length;_len>_i;_i++)match=_ref1[_i],set(match,content,style);else set(el,content,style);return null}),_i=0,_len=anchorList.length;_len>_i;_i++)for(anchor=anchorList[_i],_ref1=this._panels[anchor],i=_j=0,_len1=_ref1.length;_len1>_j;i=++_j)panel=_ref1[i],fn(panel.children[0].children[0],i,anchor);return this},OriDomi.prototype.accordion=prep(function(angle,anchor,options){return this._iterate(anchor,function(_this){return function(panel,i){var deg;if(deg=i%2===0||options.twist?angle:-angle,options.sticky?0===i?deg=0:(i>1||options.stairs)&&(deg*=2):0!==i&&(deg*=2),options.stairs&&(deg*=-1),_this._transformPanel(panel,deg,anchor,options.fracture),_this._shading){if(options.twist||options.fracture||0===i&&options.sticky)return _this._setShader(i,anchor,0);if(180!==Math.abs(deg))return _this._setShader(i,anchor,deg)}}}(this))}),OriDomi.prototype.curl=prep(function(angle,anchor){return angle/=__indexOf.call(anchorListV,anchor)>=0?this._config.vPanels.length:this._config.hPanels.length,this._iterate(anchor,function(_this){return function(panel,i){return _this._transformPanel(panel,angle,anchor),_this._shading?_this._setShader(i,anchor,0):void 0}}(this))}),OriDomi.prototype.ramp=prep(function(angle,anchor){return this._transformPanel(this._panels[anchor][1],angle,anchor),this._iterate(anchor,function(_this){return function(panel,i){return 1!==i&&_this._transformPanel(panel,0,anchor),_this._shading?_this._setShader(i,anchor,0):void 0}}(this))}),OriDomi.prototype.foldUp=prep(function(anchor,callback){return this.isFoldedUp?"function"==typeof callback?callback():void 0:this._stageReset(anchor,function(_this){return function(){return _this._inTrans=_this.isFoldedUp=!0,_this._iterate(anchor,function(panel,i){var delay,duration;return duration=_this._config.speed,0===i&&(duration/=2),delay=_this._setPanelTrans.apply(_this,[anchor].concat(__slice.call(arguments),[duration],[2])),function(panel,i,delay){return defer(function(){return _this._transformPanel(panel,0===i?90:170,anchor),setTimeout(function(){return 0===i?(_this._inTrans=!1,"function"==typeof callback?callback():void 0):hideEl(panel.children[0])},delay+.25*_this._config.speed)})}(panel,i,delay)})}}(this))}),OriDomi.prototype.unfold=prep(OriDomi.prototype._unfold),OriDomi.prototype.map=function(fn){return prep(function(_this){return function(angle,anchor,options){return _this._iterate(anchor,function(panel,i,len){return _this._transformPanel(panel,fn(angle,i,len),anchor,options.fracture)})}}(this)).bind(this)},OriDomi.prototype.reset=function(callback){return this.accordion(0,{callback:callback})},OriDomi.prototype.reveal=function(angle,anchor,options){return null==options&&(options={}),options.sticky=!0,this.accordion(angle,anchor,options)},OriDomi.prototype.stairs=function(angle,anchor,options){return null==options&&(options={}),options.stairs=options.sticky=!0,this.accordion(angle,anchor,options)},OriDomi.prototype.fracture=function(angle,anchor,options){return null==options&&(options={}),options.fracture=!0,this.accordion(angle,anchor,options)},OriDomi.prototype.twist=function(angle,anchor,options){return null==options&&(options={}),options.fracture=options.twist=!0,this.accordion(angle/10,anchor,options)},OriDomi.prototype.collapse=function(anchor,options){return null==options&&(options={}),options.sticky=!1,this.accordion(-this._config.maxAngle,anchor,options)},OriDomi.prototype.collapseAlt=function(anchor,options){return null==options&&(options={}),options.sticky=!1,this.accordion(this._config.maxAngle,anchor,options)},OriDomi.VERSION="1.1.5",OriDomi.isSupported=isSupported,OriDomi}(),("undefined"!=typeof module&&null!==module?module.exports:void 0)?module.exports=OriDomi:("undefined"!=typeof define&&null!==define?define.amd:void 0)?define(function(){return OriDomi}):window.OriDomi=OriDomi,$&&($.prototype.oriDomi=function(options){var el,instance,method,methodName,_i,_j,_len,_len1;if(!isSupported)return this;if(options===!0)return $.data(this[0],baseName);if("string"==typeof options){if(methodName=options,"function"!=typeof(method=OriDomi.prototype[methodName]))return"undefined"!=typeof console&&null!==console&&console.warn(""+libName+": No such method `"+methodName+"`"),this;for(_i=0,_len=this.length;_len>_i;_i++)el=this[_i],(instance=$.data(el,baseName))||(instance=$.data(el,baseName,new OriDomi(el,options))),method.apply(instance,Array.prototype.slice.call(arguments).slice(1))}else for(_j=0,_len1=this.length;_len1>_j;_j++)el=this[_j],(instance=$.data(el,baseName))||$.data(el,baseName,new OriDomi(el,options));return this})}.call(this);